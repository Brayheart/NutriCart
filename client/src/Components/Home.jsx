...
const Home = () => {
  return (
    <>
      <section className="bg-green-100 dark:bg-green-900">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            {/* <a
              ...
              classNameName="inline-flex items-center justify-center pe-5 py-3 mr-3 text-base font-medium text-center text-text-green-600 rounded-lg focus:ring-4 focus:ring-green-300 dark:focus:ring-green-800"
            >
              Start Simplifying
              <svg
                classNameName="w-5 h-5 ml-2 -mr-1"
                fill="currentColor"
                viewBox="0 0 20 20"
          ...
          {/* <div className="hidden lg:flex lg:col-span-5 lg:justify-center">
            <img src={myImage} className=" w-[85%]" alt="mockup"></img>
          </div> */}
        </div>
      </section>
      <section className="bg-white dark:bg-gray-200">
        <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
          ...
          <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
            <h2 className="mb-5 text-4xl tracking-tight font-extrabold text-green-700">
            ...
            {/* <Link
              to="/dashboard"
              classNameName="inline-flex items-center justify-center pe-5 mr-3 text-base font-medium text-center text-green-900 rounded-lg bg-primary-700 hover:text-sky-600 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900"
            >
              Start Simplifying
              <svg
                classNameName="w-5 h-5 ml-2 -mr-1"
      ...
      <section className="bg-white dark:bg-green-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          ...
          <div className="grid pt-8 text-left border-t border-gray-100 md:gap-16 dark:border-gray-700 md:grid-cols-2">
            <div>
              <div className="mb-10">
